      ...
      <div className="max-w-7xl mx-auto px-[6vw]">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          {doctors.map((doctor, index) => (
            <div
              key={index}
              className="bg-white rounded-2xl overflow-hidden shadow-lg border border-slate-100 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 flex flex-col md:flex-row"
            >

              {/* Image */}
              <div className="relative md:w-2/5 w-full min-h-[220px] md:min-h-0">
                <img
                  src={doctor.image}
                  alt={doctor.name}
                ...
                <div className="absolute top-4 left-4 bg-white/90 backdrop-blur px-3 py-1 rounded-full shadow text-xs font-semibold text-cyan-700">
                  Specialist
                </div>
              </div>
              ...
              <div className="p-5 flex-1 flex flex-col justify-between">
                ...
                <div>
                  ...
                  <div className="mt-3 inline-flex items-center bg-cyan-50 text-cyan-700 px-3 py-1 rounded-full text-xs font-medium">
                    ⭐ {doctor.experience}
                  </div>

                  {/* Specializations */}
                  <div className="mt-4">
                    <h4 className="font-semibold text-xs text-slate-700 mb-2">
                      Specializations
                    </h4>
                ...
                {/* Button */}
                <button className="mt-5 bg-cyan-500 hover:bg-cyan-600 text-white px-5 py-2 rounded-full text-xs font-semibold transition self-start shadow-sm">
                  Book Appointment
                </button>
